...
namespace JournalApplication.App_Start
{
    ...
    public class UnityConfig
    {
        ...
        {
            container.RegisterType<IUsersRepository, EntityFrameworkUserRepository>(new ContainerControlledLifetimeManager());
            container.RegisterType<ISessionRepository, EntityFrameworkSessionsRepository>(new ContainerControlledLifetimeManager());
